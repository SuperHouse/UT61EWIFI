      ...
      >
        <div class="Meter-Wrapper__inner">
          ...
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <rect x="13" y="30" width="74" height="2" fill="black" />
            <rect x="14" y="74" width="73" height="2" fill="black" />
            <rect
              x="14"
              y="30"
              width="46"
            ...
            <rect
              ...
              fill="black"
            />
            <rect x="24" y="24" width="15" height="1" fill="black" />
            <rect x="24" y="25" width="15" height="1" fill="black" />
            <rect
              x="24"
              y="30"
              width="5"
            ...
            <rect
              ...
              fill="black"
            />
            <rect x="67" y="24" width="11" height="1" fill="black" />
            <rect x="68" y="25" width="9" height="1" fill="black" />
            <rect
              x="67"
              y="30"
              width="5"
            ...
            <rect
              ...
              fill="black"
            />
            <path d="M76 32V74H36L76 32Z" fill="black" />
            <rect x="76" y="32" width="11" height="42" fill="black" />
          </svg>
